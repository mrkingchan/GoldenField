...
CATextLayer *InsertLabelWithCAText(id superView, id superLayer, CGRect cRect, NSString *align, NSString *contentStr, UIFont *textFont, UIColor *textColor)
{
